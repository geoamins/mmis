...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h6 class="card-title">{{ __('Basic.Student Type List') }}</h6>
            ...
            <div class="card-tools">
                ...
                @can('student-type-create')
                    <span class="float-right" style="float: right;">
                        <a class="btn btn-primary" href="{{ route('studenttype.create') }}">{{ __('Basic.Add Student Type') }}</a>
                    </span>
                @endcan
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @can('student-type-edit')
                                    <a class="btn btn-primary" href="{{ route('studenttype.edit', $studenttype->StudentTypeID) }}">{{ __('Users.Edit') }}</a>
                                @endcan
