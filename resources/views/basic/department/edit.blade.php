...
<div class="container">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header">{{ __('Basic.Edit Department') }}
                <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('department.index') }}">{{ __('Users.Back') }}</a>
                </span>
            </div>
                ...
                <form action="{{route('department.update',$data->DeptID)}}" method="POST">
                    ...
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">{{ __('Basic.Department Name') }}
