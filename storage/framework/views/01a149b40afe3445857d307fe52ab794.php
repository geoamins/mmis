            ...
            <div class="card-tools">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('district-create')): ?>
                    <span class="float-right" style="float: right;">
                        <a class="btn btn-primary" href="<?php echo e(route('district.create')); ?>">Add District</a>
                    </span>
                <?php endif; ?>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('district-edit')): ?>
                                    <a class="btn btn-primary" href="<?php echo e(route('district.edit', $district->DistrictID)); ?>">Edit</a>
                                <?php endif; ?>
...
<?php echo $__env->make('admin.adminmain', [
    ...
    'sub_menu' => 'roleslist'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rizwansarwar/Desktop/mmis/resources/views/basic/district/index.blade.php ENDPATH**/ ?>