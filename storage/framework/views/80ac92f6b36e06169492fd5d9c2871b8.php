            ...
            <div class="card-tools">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('department-create')): ?>
                    <span class="float-right" style="float: right;">
                        <a class="btn btn-primary" href="<?php echo e(route('department.create')); ?>">Add Department</a>
                    </span>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('department-create')): ?>
                                    <a class="btn btn-primary" href="<?php echo e(route('department.edit', $dept->DeptID)); ?>">Edit</a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('department-create')): ?>
...
<?php echo $__env->make('admin.adminmain', [
    ...
    'sub_menu' => 'roleslist'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rizwansarwar/Desktop/Laravel-Web/mmis/resources/views/basic/department/index.blade.php ENDPATH**/ ?>