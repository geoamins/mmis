        ...
        <div class="card">
            <div class="card-header">Edit Country
                <span class="float-right">
                    <a class="btn btn-primary" href="<?php echo e(route('basic.index')); ?>">back</a>
                </span>
            </div>


                <form action="<?php echo e(route('basic.update',$data->CountryID)); ?>" method="POST">
...
<?php echo $__env->make('admin.adminmain', [
    ...
    'sub_menu' => 'roleslist'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\mmis\resources\views/basic/edit.blade.php ENDPATH**/ ?>