        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="title_right">
                    <form action="<?php echo e(route('basic.index')); ?>" method="GET">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-create')): ?>
                    <span class="float-right" style="float: right;">
                        <a class="btn btn-primary" href="<?php echo e(route('basic.create')); ?>">Add Country</a>
                    </span>
                <?php endif; ?>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country-edit')): ?>
                                    <a class="btn btn-primary" href="<?php echo e(route('basic.edit', $basic->CountryID)); ?>">Edit</a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country-delete')): ?>

                                    <?php echo Form::open(['method' => 'DELETE','route' => ['basic.destroy', $basic->CountryID],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('admin.adminmain', [
    ...
    'sub_menu' => 'roleslist'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\mmis\resources\views/basic/index.blade.php ENDPATH**/ ?>