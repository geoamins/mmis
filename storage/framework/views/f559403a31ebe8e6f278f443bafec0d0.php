                            ...
                            <div class="third">
                                ...
                                <select id="" name="DeptID">
                                    ...
                                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($department->DeptID); ?>"><?php echo e($department->DepartmentName); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="address">
                            ...
                            <input id="addressfield" type="text" name="CurrentAddress"
                                value="<?php echo e(old('CurrentAddress')); ?>">
                            <span>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input id="addressfield" type="text" name="PermanentAddress"
                                value="<?php echo e(old('PermanentAddress')); ?>">
                            <span>
                            ...
                            <div class="third">
                                ...
                                <select id="district-dd" name="DistrictID">
                                    ...
                                    <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($district->DistrictID); ?>"><?php echo e($district->DistrictName); ?>
                            ...
                            <div class="first">
                                ...
                                <select id="" name="StudentTypeID">
                                    ...
                                    <?php $__currentLoopData = $studenttypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studenttype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($studenttype->StudentTypeID); ?>"><?php echo e($studenttype->StudentType); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#class-dd').on('change', function() {
                ...
                $("#section-dd").html('');
                $.ajax({
                    url: "<?php echo e(url('api/fetch-sections')); ?>",
                    type: "post",
                    data: {
                        ClassID: ClassID,
                        _token: '<?php echo e(csrf_token()); ?>'
