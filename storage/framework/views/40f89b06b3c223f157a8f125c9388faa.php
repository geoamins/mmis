...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('../../asset/vendors/fullcalendar/dist/fullcalendar.min.css')); ?>"
        ...
        <div class="main_container">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li
                                    class="<?php echo e(isset($menu) ? ($menu == 'userconfiguration' ? 'active open' : '') : ''); ?>">
                                    <a><i class="fa fa-home"></i> User Configuration <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                                        <li><a href="<?php echo e(route('users.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Users</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-list')): ?>
                                        <li><a href="<?php echo e(route('roles.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'roleslist' ? 'active' : '') : ''); ?>">Roles</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-list')): ?>
                                        <li><a href="<?php echo e(route('permissions.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'permissionlist' ? 'active' : '') : ''); ?>">Permissions</a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                    <?php endif; ?>
                                ...
                                <li
                                    class="<?php echo e(isset($menu) ? ($menu == 'userconfiguration' ? 'active open' : '') : ''); ?>">
                                    <a><i class="fa fa-home"></i> Basic Setting <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country-list')): ?>
                                        <li><a href="<?php echo e(route('country.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Country
                                                Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('province-list')): ?>
                                        <li><a href="<?php echo e(route('province.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Province
                                                Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('district-list')): ?>
                                        <li><a href="<?php echo e(route('district.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">District
                                                Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('department-list')): ?>
                                        <li><a href="<?php echo e(route('department.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Department
                                                Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('session-list')): ?>
                                        <li><a href="<?php echo e(route('session.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Sessions
                                                Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('student-type-list')): ?>
                                        <li><a href="<?php echo e(route('studenttype.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Student
                                                Type Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('class-list')): ?>
                                        <li><a href="<?php echo e(route('class.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Classes
                                                Setup</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('student-type-list')): ?>
                                        <li><a href="<?php echo e(route('section.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Sections
                                                Setup</a></li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                                ...
                                <li
                                    class="<?php echo e(isset($menu) ? ($menu == 'userconfiguration' ? 'active open' : '') : ''); ?>">
                                    <a><i class="fa fa-home"></i> Student <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('basic-list')): ?>
                                        <li><a href="<?php echo e(route('student.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Student
                                                Registration</a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('section-list')): ?>
                                        <li><a href="<?php echo e(route('student.index')); ?>"
                                                class="<?php echo e(isset($sub_menu) ? ($sub_menu == 'userlist' ? 'active' : '') : ''); ?>">Generate
                                                Cards</a></li>
                                        <?php endif; ?>
                                    </ul>
                                    <?php endif; ?>
            ...
            <footer>
                <div class="pull-right">
                    ...
                    <strong><?php echo e(date('Y')); ?> &copy; All Rights Reserved <a href="https://BSoft.pk/"> Travsol
                            Technologies
                            (pvt) ltd</a>.</strong>
                </div>
                <div class="clearfix"></div>
